from medster.utils.ui import UI


class Logger:
    """Logger that uses the interactive UI system for clinical analysis."""
    ...
    def log_risky(self, tool: str, input_str: str):
        self.ui.print_warning(f"Sensitive data access {tool}({input_str}) — auto-confirmed")

    def log_summary(self, summary: str):
        self.ui.print_answer(summary)

    def log_critical(self, message: str):
        """Log a critical finding requiring immediate attention."""
        self.ui.print_critical(message)
